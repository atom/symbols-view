...
export default class FileView extends SymbolsView {
  ...
  populate(filePath) {
    ...
    if (this.selectListView.refs.items) {
      this.selectListView.refs.items.empty();
    }
